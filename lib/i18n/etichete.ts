...
const RO: Etichete = {
  ...
  notaWhatsApp:
    'Butonul deschide WhatsApp cu perioada și numărul de oaspeți deja scrise. Poți modifica mesajul înainte să-l trimiți.',
...
const EN: Etichete = {
  ...
  notaWhatsApp:
    'The button opens WhatsApp with your dates and party size already written. You can edit the message before sending it.',
